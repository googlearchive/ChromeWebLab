...
p.load = function(aUrl) {
	...
	var headers = {"Upgrade": "websocket", "Connection": "Upgrade, Keep-Alive", "Sec-WebSocket-Key": nonceBase64, "Sec-WebSocket-Version": 13};
	
	var getOptions = {"host": aUrl.substring(0, colonPosition), "port": aUrl.substring(colonPosition+1, slashPosition), "path": aUrl.substring(slashPosition, aUrl.length), "headers": headers};
