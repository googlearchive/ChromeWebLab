...
exports.DrawMachineCommandLoader = new Class({
    ...
    initialize: function(options) {
        ...
        this.machine = new DrawMachine({
            MAX_DRAW_TIME: ConfigParams.MAX_DRAW_TIME
        });
    ...
    startDrawing: function() {
        ...
        this.machine.once('robotAtHome', function() {
            ...
            this.machine.once('timeEstimate', function(timeEstimate) {
                this.emit('timeEstimate', timeEstimate);
            }.bind(this));
            this.machine.start();
